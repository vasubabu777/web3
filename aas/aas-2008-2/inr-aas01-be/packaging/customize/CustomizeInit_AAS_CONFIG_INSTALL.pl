...
$VAR1 = {
 ...
 # WARNING: The QM hostname CANNOT be localhost/ 127.0.0.1
 '__VRSN_SECOND_QM_HOST' => 'inr-aas01-be',
 ...
 # a cluster.
 '__VST_THIS_HOSTNAME' => 'inr-aas01-be.qa.edcwest.vrsn.com',
 ...
 # Emailsender host name
  '__VST_AVS_MAIL_HOSTNAME' => 'inr-aas01-be.qa.edcwest.vrsn.com',
