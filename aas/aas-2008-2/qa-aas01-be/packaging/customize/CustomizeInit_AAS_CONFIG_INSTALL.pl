...
$VAR1 = {
 ...
 # WARNING: The QM hostname CANNOT be localhost/ 127.0.0.1
 '__VRSN_SECOND_QM_HOST' => 'qa-aas01-be',
 ...
 # a cluster.
 '__VST_THIS_HOSTNAME' => 'qa-aas01-be.qa.edcwest.vrsn.com',
 ...
 '__VST_AVS_SEC_AUTHENTIFY_ADAPTOR' => 'avsProd',
 ...
 '__VST_AVS_CALL01_ACCT_ID_VRSN_US' => 'VeriSign',
 '__VST_AVS_CALL01_ACCT_VRSN_US' => '',

 # Please use prodcution password for pilot/production environment
 '__VST_AVS_CALL01_PASSWD_VRSN_US' => 'g8hfbuVx',

 '__VST_AVS_CALL02_ACCT_ID_VRSN_US' => 'VeriSign',
 '__VST_AVS_CALL02_ACCT_VRSN_US' => '',

 # Please use prodcution password for pilot/production environment
 '__VST_AVS_CALL02_PASSWD_VRSN_US' => 'duecxrSu',

 '__VST_AVS_CALL01_ACCT_ID_THAWTE' => 'VeriSign',
 '__VST_AVS_CALL01_ACCT_THAWTE' => 'thawte01',

 # Please use prodcution password for pilot/production environment
 '__VST_AVS_CALL01_PASSWD_THAWTE' => 'duecxrSu',

 '__VST_AVS_CALL02_ACCT_ID_THAWTE' => 'VeriSign',
 '__VST_AVS_CALL02_ACCT_THAWTE' => 'thawte01',

 # Please use prodcution password for pilot/production environment
 '__VST_AVS_CALL02_PASSWD_THAWTE' => 'g8hfbuVx',
 ...
 # The subject of the verification mail for specific locale
  '__VST_AVS_MAIL_SUBJECT_VRSN_US' => 'VeriSign Automated Order Verification',
  '__VST_AVS_MAIL_SUBJECT_THAWTE' => 'thawte Automated Order Verification',

 # The from email address of verification mail
  '__VST_AVS_MAIL_FROM_VRSN_US' => 'support@verisign.com',
  '__VST_AVS_MAIL_FROM_THAWTE' => 'cs-support@thawte.com',

 # The verification URL included in verification mail
  '__VST_AVS_MAIL_URL_VRSN_US' => 'https://inr-verify01.bbtest.net',
  '__VST_AVS_MAIL_URL_THAWTE' => 'https://inr-thawte-verify01.bbtest.net',

 # Emailsender host name
  '__VST_AVS_MAIL_HOSTNAME' => 'qa-aas01-be.qa.edcwest.vrsn.com',

 # Configuration for AutoIssuer task
  '__VST_AVS_AUTOISSUER_LOCALES' => 'VRSN_US, THAWTE',

  # Amin cert name for VRSN_US (default)
  '__VST_AVS_ADMIN_NAME_VRSN_US' => 'VERISIGN AVS ISSUER',

  # Amin cert organization for VRSN_US (default)
  '__VST_AVS_ADMIN_ORG_VRSN_US' => 'VERISIGN',

  # Amin cert organization unit for VRSN_US (default)
  '__VST_AVS_ADMIN_ORG_UNIT_VRSN_US' => 'INTL AND DOMESTIC GROUPING',

  # Admin cert jurisdiction hash for VRSN_US (default)
  # Please uses '3c8dab435cd9a1467e636b2135d51302' for QA environment
  '__VST_AVS_ADMIN_JUR_HASH_VRSN_US' => 'c89018b7a6284b12a988e19a28938065',

  # Amin cert name for THAWTE
  '__VST_AVS_ADMIN_NAME_THAWTE' => 'THAWTE AVS ISSUER',

  # Amin cert organization for THAWTE
  '__VST_AVS_ADMIN_ORG_THAWTE' => 'VERISIGN',

  # Amin cert organization unit for THAWTE
  '__VST_AVS_ADMIN_ORG_UNIT_THAWTE' => 'THAWTECACENTER',

  # Admin cert jurisdiction hash for THAWTE
  # Please uses '3c8dab435cd9a1467e636b2135d51302' for QA environment
  '__VST_AVS_ADMIN_JUR_HASH_THAWTE' => 'c89018b7a6284b12a988e19a28938065',
  ...
  '__VST_AVS_AUTOISSUE_START_OFFSET' => '2592000',
  ...
  '__VST_AVS_AUTHENTIFY_MONITOR_STR' => 'up',
