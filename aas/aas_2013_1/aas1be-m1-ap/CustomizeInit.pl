...
$VAR1 = {
    ...
    '__VRSN_DOMAIN' => 'aas',
    '__JAVA_HOME__' => '/app/symc/java/jdk1.7.0_11',
    ...
    '__APOR_ENT_CRON_TRIGGER__' => '5 0 * * * ?',
    '__APOR_ENT_CRON_ACTIVE__' => 'true',
    '__ADMS_ENT_CRON_TRIGGER__' => '5 30 * * * ?',
