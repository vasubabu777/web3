...
$VAR1 = {
    ####### ----------- Common variables ---------------- #######
    '__VRSN_QM_HOST' => 'mmr1qmzn2be-m1-ap',
    ...
    #
    '__VST_AVS_MDS_HOST_1' => 'mmrzn4be-m1-data',
    '__VST_AVS_MDS_PORT_1' => '32001',
    '__VST_AVS_MDS_HOST_2' => 'mmrzn4be-m1-data',
    ...
    '__VST_AVS_AUTOMAIL_MAIL_URL_VRSN_US' => 'https://pv-verify.websecurity.symclab.net',
    '__VST_AVS_AUTOMAIL_MAIL_URL_THAWTE' => 'https://pv-verify.thawte.bbtest.net',

    # Emailsender host name
    '__VST_AVS_MAIL_HOSTNAME' => 'aas4be-m2-ap',
    ...
    '__APOR_ENT_CRON_TRIGGER__' => '10 15 * * * ?',
    '__APOR_ENT_CRON_ACTIVE__' => 'true',
    '__ADMS_ENT_CRON_TRIGGER__' => '10 45 * * * ?',
    ...
    '__VRSN_SENTINEL_SERVICE_URL__' => 'pv-sentinel.bbtest.net',
    ...
    '__VST_AVS_AUTOMAIL_MAIL_URL_GEOTRUST__' => 'https://pv-verify.geotrust.symclab.net',
};
