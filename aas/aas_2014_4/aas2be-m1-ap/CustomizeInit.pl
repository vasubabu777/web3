...
$VAR1 = {
    ####### ----------- Common variables ---------------- #######
    '__VRSN_QM_HOST' => 'devqm1be-m1-ap',
    '__VRSN_QM_PORT' => '20082',
    '__VRSN_JBOSS_SERVER_DIR' => '/app/jboss/server',
    '__VRSN_DOMAIN' => 'aas',
    '__JAVA_HOME__' => '/app/symc/java/jdk1.7.0_55',
    '__HTTP_PORT__' => '8080',
    '__AJP_PORT__' => '8009',
    ...
    '__VST_ADMS_SERVICE_HOST' => 'adms2.bbtest.net',
    ...
    #
    '__VST_AVS_MDS_HOST_1' => 'mmr2be-m2-data',
    '__VST_AVS_MDS_PORT_1' => '32001',
    '__VST_AVS_MDS_HOST_2' => 'mmr2be-m2-data',
    ...
    '__VST_AVS_CLEANUP_START_TIME' => '20',
    '__VST_AVS_AUTOMAIL_START_TIME' => '20',
    '__VST_AVS_AUTOISSUER_START_TIME' => '20',
 
    # The interval of the timer in minutes.
    '__VST_AVS_CLEANUP_INTERVAL' => '20',
    '__VST_AVS_AUTOMAIL_INTERVAL' => '20',
    '__VST_AVS_AUTOISSUER_INTERVAL' => '10',
    ...
    '__VST_AVS_AUTOISSUER_RUN_LENGTH' => '8',
    ...
    '__VST_AVS_AUTOMAIL_SUBJECT_VRSN_US' => 'Symantec Automated Order Verification',
    ...
    '__VST_AVS_AUTOMAIL_MAIL_URL_VRSN_US' => 'https://verify2.websecurity.symclab.net',
    '__VST_AVS_AUTOMAIL_MAIL_URL_THAWTE' => 'https://verify-thawte2.bbtest.net',
    ...
    '__VST_AVS_AUTOISSUER_LOCALES' => 'VRSN_US, THAWTE',
     ...
     '__VST_AVS_AUTOISSUER_ADMIN_CERT_NAME_VRSN_US' => 'SYMANTEC AVS ISSUER',
     ...
     '__VST_APOR_MAIL_HOSTNAME' => 'aas2be-m1-ap',
    ...
    '__APOR_ENT_CRON_TRIGGER__' => '15 0 * * * ?',
    '__APOR_ENT_CRON_ACTIVE__' => 'true',
    '__ADMS_ENT_CRON_TRIGGER__' => '15 0 * * * ?',
    '__ADMS_ENT_CRON_ACTIVE__' => 'true',
    '__ORACLE_SERVICE__' => '(DESCRIPTION = (ADDRESS_LIST = (ADDRESS = (PROTOCOL = TCP)(HOST = fire-scan.ssoqa-bo.mtv1.vrsn.com)(PORT = 1521))(ADDRESS = (PROTOCOL = TCP)(HOST = 10.204.145.18 )(PORT = 1521))(ADDRESS = (PROTOCOL = TCP)(HOST = 10.204.145.19)(PORT = 1521))(ADDRESS = (PROTOCOL = TCP)(HOST = 10.204.145.20)(PORT = 1521)) )(CONNECT_DATA = (SERVICE_NAME = ECASQAEVEN)))',
    '__ORACLE_USERNAME__' => 'apps',
    '__ORACLE_PASSWORD__' => 'password',
    '__VRSN_SENTINEL_SERVICE_URL__' => 'sentinel2.bbtest.net',
    ...
    '__VST_AVS_AUTHENTIFY_VERIFICATION_CALL_01_PASSWORD_VRSN_US' => 'e129d727-8051-4407-855c-f2e902c57169',
    '__VST_AVS_AUTHENTIFY_VERIFICATION_CALL_02_PASSWORD_VRSN_US' => 'e129d727-8051-4407-855c-f2e902c57169',
    '__VST_AVS_AUTHENTIFY_VERIFICATION_CALL_01_PASSWORD_THAWTE' => 'e129d727-8051-4407-855c-f2e902c57169',
    '__VST_AVS_AUTHENTIFY_VERIFICATION_CALL_02_PASSWORD_THAWTE' => 'e129d727-8051-4407-855c-f2e902c57169',

    '__VST_AVS_AUTHENTIFY_VERIFICATION_CALL_01_ACCOUNT_ID_GEOTRUST__' => 'VeriSign',
    '__VST_AVS_AUTHENTIFY_VERIFICATION_CALL_01_ACCOUNT_GEOTRUST__' => 'geotrust',
    '__VST_AVS_AUTHENTIFY_VERIFICATION_CALL_01_PASSWORD_GEOTRUST__' => 'e129d727-8051-4407-855c-f2e902c57169',
    '__VST_AVS_AUTHENTIFY_VERIFICATION_CALL_02_ACCOUNT_ID_GEOTRUST__' => 'VeriSign',
    '__VST_AVS_AUTHENTIFY_VERIFICATION_CALL_02_ACCOUNT_GEOTRUST__' => 'geotrust',
    '__VST_AVS_AUTHENTIFY_VERIFICATION_CALL_02_PASSWORD_GEOTRUST__' => 'e129d727-8051-4407-855c-f2e902c57169',
    '__VST_AVS_AUTOMAIL_LOCALES__' => 'VRSN_US, VRSN_GB, VRSN_AU, VRSN_HK, VRSN_SG, VRSN_CH, THAWTE, GEOTRUST_US, GEOTRUST_AU, GEOTRUST_GB, GEOTRUST_CH',
    '__VST_AVS_AUTOMAIL_SUBJECT_GEOTRUST__' => 'GeoTrust Automated Order Verification',
    '__VST_AVS_AUTOMAIL_MAIL_FROM_MAIL_GEOTRUST__' => 'testlabs@verisign.com',
    '__VST_AVS_AUTOMAIL_MAIL_URL_GEOTRUST__' => 'https://verify2.geotrust.symclab.net',
};
