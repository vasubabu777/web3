...
$VAR1 = {
    ...
    '__VST_ADMS_SERVICE_HOST' => 'adms4.bbtest.net',
    ...
    '__VST_AVS_AUTOMAIL_MAIL_URL_VRSN_US' => 'https://verify4.websecurity.symclab.net',
    '__VST_AVS_AUTOMAIL_MAIL_URL_THAWTE' => 'https://verify-thawte4.bbtest.net',
    ...
    '__ORACLE_SERVICE__' => '(DESCRIPTION=(ADDRESS_LIST=(ADDRESS=(PROTOCOL=TCP)(HOST=10.204.144.209)(PORT=1521))(ADDRESS=(PROTOCOL=TCP)(HOST=10.204.144.208)(PORT=1521))(FAILOVER=on))(CONNECT_DATA=(SERVICE_NAME=ECASEVEN)))',
    '__ORACLE_USERNAME__' => 'apps',
    '__ORACLE_PASSWORD__' => 'password',
    '__VRSN_SENTINEL_SERVICE_URL__' => 'sentinel4.bbtest.net',
