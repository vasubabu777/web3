...
$VAR1 = {
    ...
    '__VST_ADMS_SERVICE_HOST' => 'adms1.bbtest.net',
    ...
    '__VST_AVS_CLEANUP_START_TIME' => '15',
    '__VST_AVS_AUTOMAIL_START_TIME' => '15',
    '__VST_AVS_AUTOISSUER_START_TIME' => '15',
    ...
    '__VST_AVS_AUTOMAIL_MAIL_URL_VRSN_US' => 'https://verify1.websecurity.symclab.net',
    '__VST_AVS_AUTOMAIL_MAIL_URL_THAWTE' => 'https://verify-thawte1.bbtest.net',
    ...
    '__VST_AVS_AUTOISSUER_LOCALES' => 'VRSN_US, THAWTE',
     ...
     '__VST_APOR_MAIL_HOSTNAME' => 'aas1be-m1-ap',
    ...
    '__APOR_ENT_CRON_TRIGGER__' => '0 0/15 * * * ?',
    '__APOR_ENT_CRON_ACTIVE__' => 'true',
    '__ADMS_ENT_CRON_TRIGGER__' => '0 0/15 * * * ?',
    '__ADMS_ENT_CRON_ACTIVE__' => 'true',
    '__ORACLE_SERVICE__' => '(DESCRIPTION = (ADDRESS_LIST = (ADDRESS = (PROTOCOL = TCP)(HOST = fire-scan.ssoqa-bo.mtv1.vrsn.com)(PORT = 1521))(ADDRESS = (PROTOCOL = TCP)(HOST = 10.204.145.18 )(PORT = 1521))(ADDRESS = (PROTOCOL = TCP)(HOST = 10.204.145.19)(PORT = 1521))(ADDRESS = (PROTOCOL = TCP)(HOST = 10.204.145.20)(PORT = 1521)) )(CONNECT_DATA = (SERVICE_NAME = ECASQAODD)))',
    '__ORACLE_USERNAME__' => 'apps',
    '__ORACLE_PASSWORD__' => 'password',
    '__VRSN_SENTINEL_SERVICE_URL__' => 'sentinel1.bbtest.net',
    ...
    '__VST_AVS_AUTOMAIL_MAIL_URL_GEOTRUST__' => 'https://verify1.geotrust.symclab.net',
};
