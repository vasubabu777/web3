...
$VAR1 = {
    ...
    '__ORACLE_SERVICE__' => '(DESCRIPTION =(failover=on) (ADDRESS_LIST = (ADDRESS = (PROTOCOL = TCP)(HOST = fire-scan.ssoqa-bo.mtv1.vrsn.com)(PORT = 1521))(ADDRESS = (PROTOCOL = TCP)(HOST = 10.204.145.18 )(PORT = 1521))(ADDRESS = (PROTOCOL = TCP)(HOST = 10.204.145.19)(PORT = 1521))(ADDRESS = (PROTOCOL = TCP)(HOST = 10.204.145.20)(PORT = 1521)) )(CONNECT_DATA = (SERVICE_NAME = ECASQAODD)(FAILOVER_MODE= (TYPE= session) (METHOD= basic) (retries=20) (delay=1))))',
